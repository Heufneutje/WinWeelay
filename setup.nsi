...
!define MUI_FINISHPAGE_RUN_TEXT "Run WinWeelay"
...
InstallDir "$PROGRAMFILES\WinWeelay"
Function .onInit
    ${If} ${RunningX64}
        SetRegView 64
        StrCpy $INSTDIR "$PROGRAMFILES64\WinWeelay"
    ${EndIf}
		...
		${IfNot} $2 == ''
		Messagebox MB_OK|MB_ICONINFORMATION "The WinWeelay update will now be installed."
		StrCpy $INSTDIR $2
		${EndIf}
...
FunctionEnd
Function LaunchLink
	ExecShell "" "$INSTDIR\WinWeelay.exe"
FunctionEnd
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "WinWeelay"
...
SetOutPath "$INSTDIR"
File "Release\Ionic.Zlib.dll"
File "Release\LICENSE.txt"
File "Release\Microsoft.Expression.Interactions.dll"
File "Release\MLib.dll"
File "Release\MLib.pdb"
File "Release\MWindowInterfacesLib.dll"
File "Release\MWindowInterfacesLib.pdb"
File "Release\MWindowLib.dll"
File "Release\MWindowLib.pdb"
File "Release\Newtonsoft.Json.dll"
File "Release\System.Reactive.dll"
File "Release\System.Runtime.CompilerServices.Unsafe.dll"
File "Release\System.Threading.Tasks.Extensions.dll"
File "Release\System.ValueTuple.dll"
File "Release\System.Windows.Interactivity.dll"
File "Release\Websocket.Client.dll"
File "Release\Windows.winmd"
File "Release\WinWeelay.Configuration.dll"
File "Release\WinWeelay.Configuration.pdb"
File "Release\WinWeelay.Core.dll"
File "Release\WinWeelay.Core.pdb"
File "Release\WinWeelay.exe"
File "Release\WinWeelay.exe.config"
File "Release\WinWeelay.pdb"
File "Release\WinWeelay.CustomControls.dll"
File "Release\WinWeelay.CustomControls.pdb"
File "Release\WinWeelay.Utils.dll"
File "Release\WinWeelay.Utils.pdb"
File "Release\Xceed.Wpf.AvalonDock.dll"
File "Release\Xceed.Wpf.AvalonDock.pdb"
File "Release\Xceed.Wpf.AvalonDock.Themes.VS2013.dll"
File "Release\Xceed.Wpf.AvalonDock.Themes.VS2013.pdb"
SectionEnd
...
CreateDirectory "$SMPROGRAMS\WinWeelay"
CreateShortCut "$SMPROGRAMS\WinWeelay\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$SMPROGRAMS\WinWeelay\Uninstall ${APP_NAME}.lnk" "$INSTDIR\uninstall.exe"

!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} website.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\WinWeelay\${APP_NAME} Website.lnk" "$INSTDIR\${APP_NAME} website.url"
!endif
!endif
...
Messagebox MB_OK|MB_ICONINFORMATION "The WinWeelay update has been installed."
Call LaunchLink
${EndIf}
...
Section Uninstall
${INSTALL_TYPE}
Delete "$INSTDIR\Ionic.Zlib.dll"
Delete "$INSTDIR\LICENSE.txt"
Delete "$INSTDIR\Microsoft.Expression.Interactions.dll"
Delete "$INSTDIR\MLib.dll"
Delete "$INSTDIR\MLib.pdb"
Delete "$INSTDIR\MWindowInterfacesLib.dll"
Delete "$INSTDIR\MWindowInterfacesLib.pdb"
Delete "$INSTDIR\MWindowLib.dll"
Delete "$INSTDIR\MWindowLib.pdb"
...
Delete "$INSTDIR\Windows.winmd"
Delete "$INSTDIR\WinWeelay.Configuration.dll"
Delete "$INSTDIR\WinWeelay.Configuration.pdb"
Delete "$INSTDIR\WinWeelay.Core.dll"
Delete "$INSTDIR\WinWeelay.Core.pdb"
Delete "$INSTDIR\WinWeelay.exe"
Delete "$INSTDIR\WinWeelay.exe.config"
Delete "$INSTDIR\WinWeelay.pdb"
Delete "$INSTDIR\WinWeelay.CustomControls.dll"
Delete "$INSTDIR\WinWeelay.CustomControls.pdb"
Delete "$INSTDIR\WinWeelay.Utils.dll"
Delete "$INSTDIR\WinWeelay.Utils.pdb"
Delete "$INSTDIR\Xceed.Wpf.AvalonDock.dll"
Delete "$INSTDIR\Xceed.Wpf.AvalonDock.pdb"
Delete "$INSTDIR\Xceed.Wpf.AvalonDock.Themes.VS2013.dll"
Delete "$INSTDIR\Xceed.Wpf.AvalonDock.Themes.VS2013.pdb"
...
!ifndef REG_START_MENU
Delete "$SMPROGRAMS\WinWeelay\${APP_NAME}.lnk"
Delete "$SMPROGRAMS\WinWeelay\Uninstall ${APP_NAME}.lnk"
!ifdef WEB_SITE
Delete "$SMPROGRAMS\WinWeelay\${APP_NAME} Website.lnk"
!endif
Delete "$DESKTOP\${APP_NAME}.lnk"
Delete "$SMSTARTUP\${APP_NAME}.lnk"

RmDir "$SMPROGRAMS\WinWeelay"
!endif
