...
{
    public class WinWeeRelayObject
    {
        ...
        public WinWeeRelayObject()
        {
            // Does nothing
        }

        public WinWeeRelayObject(char c)
        {
            _charValue = c;
            Type = WeechatType.CHR;
        }

        public WinWeeRelayObject(int i)
        {
            _intValue = i;
            Type = WeechatType.INT;
        }

        public WinWeeRelayObject(long l)
        {
            _longValue = l;
            Type = WeechatType.LON;
        }

        public WinWeeRelayObject(string s)
        {
            _strValue = s;
            Type = WeechatType.STR;
        }

        public WinWeeRelayObject(byte[] b)
        {
            _baValue = b;
            Type = WeechatType.BUF;
        }

        public WinWeeRelayObject(WeechatArray array)
        {
            _arrayValue = array;
